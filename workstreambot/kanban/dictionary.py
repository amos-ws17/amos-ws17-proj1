...
kanban_general_keys = ['kanban', 'artefact', 'board', 'ticket', 'estimation', 'wip', 'pull principle', 'ceremony']

# the explanations of the general topics
kanban_general_keys_values = {
...
kanban_details_keys = [['history', 'kaizen'],
