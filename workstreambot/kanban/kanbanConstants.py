...
kanbanGeneralKeys = ['kanban', 'artefacts', 'kanban board', 'tickets',
				'estimations', 'wip', 'pull principle', 'ceremonies']
...
kanbanGeneralKeysValues = {
    ...
    'artefacts': 'The kanban board with its cards, the Cumulative Flow Diagram (CFD), Run Chart, Lead Time Distribution Chart.',
    'kanban board': 'A Kanban Board has at least three columns and at least two rows.'
    ...
    'tickets': 'Kanban defines three types of Tickets:'
    ...
    'estimations': 'You don’t have to estimate anything.'
    ...
    'ceremonies': 'The replenishment meeting is used to fill the ToDo column with the tickets to be done.'
